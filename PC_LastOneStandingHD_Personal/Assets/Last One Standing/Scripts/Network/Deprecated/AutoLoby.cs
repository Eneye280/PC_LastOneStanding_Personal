...
public class AutoLoby : MonoBehaviourPunCallbacks
{
    ...
    [SerializeField] internal byte maxPlayerPerRoom = 4;
    
    [Space(10)]
    [SerializeField] internal Button connectButton;
    [SerializeField] internal Button JoinRandomButton;
    
    [Space(10)]
    [SerializeField] internal Text log;
    [SerializeField] internal Text playerCount;
